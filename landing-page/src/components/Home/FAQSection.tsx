...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "O livro reúne uma metodologia prática e material complementar para consulta contínua. Entre em contato pelo WhatsApp para conhecer os formatos disponíveis e as condições especiais.",
  },
  {
...
const FAQItem = ({ faq, index, isOpen, onToggle }: FAQItemProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <h3
          className="text-white pr-8 group-hover:text-white/80 transition-colors text-left font-medium"
          style={{ fontSize: "18px" }}
        >
          {faq.question}
        </h3>
      ...
      <div className="max-w-6xl w-full mx-auto px-6 relative z-10 pb-24">
        ...
        <div className="mt-16 text-center">
          <div className="p-8 rounded-2xl border border-white/10 bg-white/[0.02]">
            <h3 className="text-2xl text-white mb-4">Ainda tem dúvidas?</h3>
